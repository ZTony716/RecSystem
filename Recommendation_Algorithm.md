...
```
User Actions
(view / add to cart / purchase intent)
        ↓
Stored in PostgreSQL (user_events)
        ↓
Behavior weights applied
        ↓
Recommendation queries executed
        ↓
Popular / Personalized / Similar / Also-Viewed results returned
        ↓
